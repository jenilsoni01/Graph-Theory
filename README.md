...
> 7. Model a social media platform as a graph where Users represent vertices (nodes) and Friendships / follow relationships represent edges. Perform following tasks.
> a. Connectivity and Vulnerability Analysis.
> - Identify all cut sets and compute the minimum cut.
...
> - Analyze partition results in the context of community detection
> 8. Write a program to identify the minimum cut-edges in a graph using Kerger’s randomized algorithm. Students will learn edge contraction.
> 9. Develop a program to find all articulation points in a graph by leveraging a Depth-First Search (DFS) tree.
> 10. Write a program to check whether the graph is planar or not. Apply elementary reduction and check for the resultant three condition of planarity.
